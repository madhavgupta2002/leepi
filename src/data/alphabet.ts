...
export const CONSONANTS: ConsonantDef[] = [
    ...
    { id: "c-kha", telugu: "ఖ", onsetIso: "kh", onsetPhonetic: "kh", group: "Velar", example: { telugu: "ఖర్చు", iso: "kharcu", phonetic: "kharchu", english: "expense" } },
    { id: "c-ga", telugu: "గ", onsetIso: "g", onsetPhonetic: "g", group: "Velar", example: { telugu: "గాలి", iso: "gāli", phonetic: "gaali", english: "wind" } },
    { id: "c-gha", telugu: "ఘ", onsetIso: "gh", onsetPhonetic: "gh", group: "Velar", example: { telugu: "ఘంట", iso: "ghaṁṭa", phonetic: "ghanta", english: "bell" } },
    { id: "c-nga", telugu: "ఙ", onsetIso: "ṅ", onsetPhonetic: "ng", group: "Velar", example: { telugu: "సఙ్ఘం", iso: "saṅghaṁ", phonetic: "sangham", english: "community" } },
    { id: "c-ca", telugu: "చ", onsetIso: "c", onsetPhonetic: "ch", group: "Palatal", example: { telugu: "చేప", iso: "cēpa", phonetic: "chaepa", english: "fish" } },
    { id: "c-cha", telugu: "ఛ", onsetIso: "ch", onsetPhonetic: "chh", group: "Palatal", example: { telugu: "ఛత్రం", iso: "chatraṁ", phonetic: "chhatram", english: "umbrella" } },
    { id: "c-ja", telugu: "జ", onsetIso: "j", onsetPhonetic: "j", group: "Palatal", example: { telugu: "జింక", iso: "jiṅka", phonetic: "jinka", english: "deer" } },
    { id: "c-jha", telugu: "ఝ", onsetIso: "jh", onsetPhonetic: "jh", group: "Palatal", example: { telugu: "ఝరి", iso: "jhari", phonetic: "jhari", english: "stream" } },
    { id: "c-nya", telugu: "ఞ", onsetIso: "ñ", onsetPhonetic: "ny", group: "Palatal", example: { telugu: "జ్ఞానం", iso: "jñānaṁ", phonetic: "jnanam", english: "knowledge" } },
    ...
    { id: "c-ttha", telugu: "ఠ", onsetIso: "ṭh", onsetPhonetic: "th", group: "Retroflex", example: { telugu: "ఠీవి", iso: "ṭhīvi", phonetic: "theevi", english: "dignity" } },
    { id: "c-dda", telugu: "డ", onsetIso: "ḍ", onsetPhonetic: "d", group: "Retroflex", example: { telugu: "డబ్బు", iso: "ḍabbu", phonetic: "dabbu", english: "money" } },
    { id: "c-ddha", telugu: "ఢ", onsetIso: "ḍh", onsetPhonetic: "dh", group: "Retroflex", example: { telugu: "ఢంకా", iso: "ḍhaṁkā", phonetic: "dhanka", english: "drum" } },
    { id: "c-nna", telugu: "ణ", onsetIso: "ṇ", onsetPhonetic: "n", group: "Retroflex", example: { telugu: "మణి", iso: "maṇi", phonetic: "mani", english: "gem" } },
    { id: "c-ta", telugu: "త", onsetIso: "t", onsetPhonetic: "t", group: "Dental", example: { telugu: "తల", iso: "tala", phonetic: "tala", english: "head" } },
    { id: "c-tha", telugu: "థ", onsetIso: "th", onsetPhonetic: "th", group: "Dental", example: { telugu: "థాలీ", iso: "thālī", phonetic: "thaali", english: "plate" } },
    { id: "c-da", telugu: "ద", onsetIso: "d", onsetPhonetic: "d", group: "Dental", example: { telugu: "దీపం", iso: "dīpaṁ", phonetic: "deepam", english: "lamp" } },
    { id: "c-dha", telugu: "ధ", onsetIso: "dh", onsetPhonetic: "dh", group: "Dental", example: { telugu: "ధనం", iso: "dhanaṁ", phonetic: "dhanam", english: "wealth" } },
    ...
    { id: "c-pha", telugu: "ఫ", onsetIso: "ph", onsetPhonetic: "ph", group: "Labial", example: { telugu: "ఫలం", iso: "phalaṁ", phonetic: "phalam", english: "fruit" } },
    { id: "c-ba", telugu: "బ", onsetIso: "b", onsetPhonetic: "b", group: "Labial", example: { telugu: "బడి", iso: "baḍi", phonetic: "badi", english: "school" } },
    { id: "c-bha", telugu: "భ", onsetIso: "bh", onsetPhonetic: "bh", group: "Labial", example: { telugu: "భాష", iso: "bhāṣa", phonetic: "bhaasha", english: "language" } },
    ...
    { id: "c-ssa", telugu: "ష", onsetIso: "ṣ", onsetPhonetic: "sh", group: "Sibilant", example: { telugu: "నష్టం", iso: "naṣṭaṁ", phonetic: "nashtam", english: "loss" } },
    ...
    { id: "c-lla", telugu: "ళ", onsetIso: "ḷ", onsetPhonetic: "l", group: "Other", example: { telugu: "ముళ్ళు", iso: "muḷḷu", phonetic: "mullu", english: "thorns" } },
    { id: "c-ksha", telugu: "క్ష", onsetIso: "kṣ", onsetPhonetic: "ksh", group: "Other", example: { telugu: "క్షణం", iso: "kṣaṇaṁ", phonetic: "kshanam", english: "moment" } },
    { id: "c-rra", telugu: "ఱ", onsetIso: "ṟ", onsetPhonetic: "r", group: "Other", example: { telugu: "ఱాయి", iso: "ṟāyi", phonetic: "rayi", english: "stone (classical)" } },
];
