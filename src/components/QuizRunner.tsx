            ...
            <li key={q.id} className="rounded-xl border border-border bg-card p-4">
              ...
              <div className="mt-3 space-y-1.5 text-sm">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <span
                    className={`rounded-md bg-green-500/15 px-2 py-0.5 font-medium text-green-700 dark:text-green-300 ${
                      correctOpt?.isTelugu ? "telugu text-lg" : ""
                    }`}
                  >
                    {correctOpt?.label}
                  </span>
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <span
                      className={`rounded-md px-2 py-0.5 font-medium ${
                        chosenOpt ? "bg-red-500/15 text-red-700 dark:text-red-300" : "bg-border text-muted"
