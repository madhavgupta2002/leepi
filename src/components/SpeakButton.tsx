...
export function SpeakButton({
  ...
  return (
    <button
      ...
      className={`inline-flex items-center justify-center rounded-full border border-border bg-card text-foreground transition hover:bg-accent/10 hover:text-accent ${dim} ${
        failed ? "opacity-40" : ""
      } ${className}`}
